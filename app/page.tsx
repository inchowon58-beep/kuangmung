...
const processSteps = [
  {
    ...
    title: "전화 상담",
    description:
      "수원강아지파양·수원강아지보호소 상담 전화(0505-707-0401)로 먼저 연락 주세요. 반려견의 나이, 성격, 파양 사유를 비밀 보장 하에 편안하게 상담해 드립니다.",
  },
  {
    step: "2",
    title: "상담 및 맞춤 안내",
    description:
      "수원유기견보호소·수원유기견보호센터 연계 절차를 보호자님 상황에 맞게 안내합니다. 파양 전 충분한 대화를 통해 반려견에게 가장 좋은 방법을 함께 찾습니다.",
  },
  {
    step: "3",
    title: "보호소 입소",
    description:
      "수원유기견센터 연계 보호소에 입소하면 일상 케어와 정서 안정 프로그램이 시작됩니다. 유기동물보호소 기준에 맞는 안전한 공간에서 반려견을 돌봅니다.",
  },
  {
    step: "4",
    title: "입양·무료분양 연계",
    description:
      "안정된 후 책임 있는 가정에 강아지무료분양을 연계합니다. 수원강아지파양 이후에도 입양 가정과의 사후 관리를 이어갑니다.",
  },
];
...
const serviceItems = [
  {
    title: "수원강아지파양 상담",
    text: "갑작스러운 상황 변화로 반려견을 맡기셔야 할 때, 수원강아지파양 전문 상담으로 차분하고 안전한 절차를 안내해 드립니다.",
  },
  {
    title: "수원강아지보호소·수원유기견보호소 연계",
    text: "수원강아지보호소 및 수원유기견보호소와 협력하여 반려견이 낯선 환경에서도 불안하지 않도록 세심한 보호 환경을 마련합니다.",
  },
  {
    title: "수원유기견센터·수원유기견보호센터 안내",
    text: "수원유기견센터 등록부터 수원유기견보호센터 입소, 필요한 건강 관리까지 한곳에서 꼼꼼하게 안내합니다.",
  },
  {
...
const promises = [
  {
    num: "01",
    title: "먼저 귀 기울입니다",
    text: "수원강아지파양·수원강아지보호소 상담은 보호자님의 이야기부터 듣습니다. 반려견과 사람 모두에게 맞는 방법을 함께 고민합니다.",
  },
  {
    num: "02",
    title: "끝까지 함께합니다",
    text: "수원유기견보호센터 입소 이후에도 일상 케어, 강아지무료분양 입양 연계, 사후 관리까지 책임 있는 지원을 이어갑니다.",
  },
  {
    num: "03",
    title: "정직하게 안내합니다",
    text: "수원유기견보호소 보호 과정과 비용을 숨기지 않습니다. 유기동물보호소 기준에 맞는 투명한 운영이 신뢰의 시작입니다.",
  },
];

const faqItems = [
  {
    question: "수원강아지파양은 어떤 경우에 이용하나요?",
    answer:
      "이사, 알레르기, 경제적 사정, 가족 변화 등 부득이한 사유로 직접 돌보기 어려울 때 이용하실 수 있습니다. 수원강아지보호소·수원유기견보호소 상담을 통해 임시 보호, 가족 위탁 등 다른 방법도 함께 안내해 드립니다.",
  },
  {
    question: "수원유기견센터와 수원유기견보호센터는 어떻게 다른가요?",
    answer:
      "수원유기견센터는 유기견 행정·관리 기관이며, 수원유기견보호센터는 실제 보호와 케어가 이루어지는 시설입니다. 본 상담센터는 두 기관과 연계해 파양·보호·입양 절차를 안내합니다.",
  },
  {
  ...
  {
    question: "수원 지역 외에서도 파양이 가능한가요?",
    answer:
      "주로 수원 및 경기 남부 인근 지역을 대상으로 운영하고 있으나, 상황에 따라 방문 상담이 가능합니다. 수원유기견보호소 입소 전 먼저 전화 상담을 통해 거주 지역과 반려견 정보를 알려 주세요.",
  },
  {
    question: "유기동물보호소 이용 시 비용이 발생하나요?",
    answer:
      "보호소 운영비, 건강 관리비, 사료·의료비 등 실비가 발생할 수 있습니다. 수원강아지파양·수원강아지보호소 상담 시 투명하게 안내해 드리며, 어려우신 경우에도 최대한 도움을 드리고 있습니다.",
  },
  {
    question: "입양 후에도 연락이 가능한가요?",
    answer:
      "네, 입양 가정과의 사후 관리를 위해 정기적인 안부 확인을 진행합니다. 수원강아지파양·강아지무료분양을 통해 보호된 반려견이 새 가정에서 잘 지낼 수 있도록 지속적으로 지원합니다.",
  },
];
          ...
          <div className="mx-auto grid max-w-6xl items-center gap-12 px-4 py-16 sm:px-8 lg:grid-cols-2 lg:py-28">
            <div>
              ...
              <p className="mt-2 font-serif text-lg text-aga-brown sm:text-xl">
                수원유기견보호소 · 반려견을 위한 따뜻한 안내
              </p>
              <p className="mt-6 max-w-lg text-sm leading-relaxed text-warm sm:text-base">
                수원강아지파양·수원강아지보호소·수원유기견보호소 전문
                상담센터입니다. 수원유기견센터·수원유기견보호센터와
        ...
        >
          <div className="mx-auto max-w-4xl px-4 text-center sm:px-8">
            ...
            <p className="mx-auto mt-8 max-w-xl text-sm leading-relaxed text-warm sm:text-base">
              수원강아지파양은 반려견 입양뿐 아니라 불가피한 파양을
              고민하는 보호자에게도 문을 엽니다. 수원유기견보호소·
            ...
            <div className="grid gap-16 lg:grid-cols-2">
              <div>
                ...
                <p className="mt-6 text-sm leading-relaxed text-warm sm:text-base">
                  수원강아지파양부터 수원유기견센터·수원유기견보호센터
                  연계, 강아지무료분양·유기동물보호소 입양까지 수원 지역
                  반려견 보호 전 과정을 안내합니다.
                </p>
              </div>
        ...
        >
          <div className="mx-auto max-w-6xl px-4 sm:px-8">
            ...
            <p className="mt-6 max-w-2xl text-sm leading-relaxed text-warm sm:text-base">
              수원유기견보호소·유기동물보호소 기준에 맞춰 반려견이 안전하고
      ...
      <footer className="border-t border-charcoal/10 bg-aga-dark py-12 text-cream">
        <div className="mx-auto max-w-6xl px-4 sm:px-8">
          ...
          <p className="mt-6 text-center text-[10px] leading-relaxed text-warm-light/70">
            수원강아지파양 · 수원강아지보호소 · 수원유기견보호소 ·
            수원유기견센터 · 수원유기견보호센터 · 강아지무료분양 ·
            유기동물보호소
          </p>
          <p className="mt-3 text-center text-[10px] text-warm-light/50">
            © {new Date().getFullYear()} 아가펫보호소 · 수원강아지파양 안내
          </p>
        </div>
      </footer>
